...
metadata:
  ...
  vault: Skills/Custom/copy-editing
  version: 2.0.0
---
...
**Role:** Edit existing marketing copy (checker pass). Do not use the same turn that wrote the copy as the sole editor when stakes are high — Writer ≠ Checker.

**Handoffs**
- New copy from scratch → `copywriting`
- Page-level conversion issues → `cro`
