...
metadata:
  source: adapted from coreyhaines31/marketingskills (MIT)
  vault: Skills/Custom/product-marketing
  version: 2.1.0
---
...
**Upstream:** [coreyhaines31/marketingskills](https://github.com/coreyhaines31/marketingskills) · MIT · see [[Skills/Custom/marketingskills-NOTICE]].

**Role:** Shared product/audience/positioning context for other marketing skills. Creates **product-repo** residue at `.agents/product-marketing.md` (not vault methodology).

**Handoffs**
- Page structure / conversion layout → `landing-page` / `product-page`
- SEO page structure → `seo-page`
- Full upstream skill library (not vendored here) → [[Toolbox/Marketing-Skills]]

**Do not** treat this skill as a substitute for a marketing hire, brand owner, or measurement loop.
