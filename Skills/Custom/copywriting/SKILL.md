...
metadata:
  ...
  vault: Skills/Custom/copywriting
  version: 2.0.2
---
...
**Role:** Write persuasive marketing copy. Prefer reading `.agents/product-marketing.md` first (from `product-marketing`).

**Handoffs**
- Edit / tighten existing copy → `copy-editing` (Writer ≠ Checker)
- Landing / PDP structure → `landing-page` / `product-page`
- Conversion diagnosis before rewrite → `cro`
- Emails, popups, offers (upstream-only) → install from [[Toolbox/Marketing-Skills]] in the product repo
